...
const profileFormPopup = document.querySelector('.popup__profile_form');
...
const placeFormPopup = document.querySelector('.popup__place_form');
...
const picturePopup = document.querySelector('.popup__picture_popup');
